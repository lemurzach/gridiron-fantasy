...
-- CreateIndex
CREATE UNIQUE INDEX "RosterPlayer_leagueMemberId_playerId_key" ON "RosterPlayer"("leagueMemberId", "playerId");

-- CreateIndex
CREATE UNIQUE INDEX "SeasonSchedule_leagueId_week_key" ON "SeasonSchedule"("leagueId", "week");

-- CreateIndex
CREATE UNIQUE INDEX "WeekStats_playerId_scheduleId_key" ON "WeekStats"("playerId", "scheduleId");
